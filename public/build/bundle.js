...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 1, 4, 28);
    			add_location(p, file$6, 2, 4, 60);
    			add_location(li0, file$6, 4, 8, 162);
    			add_location(li1, file$6, 6, 12, 217);
    			add_location(ul0, file$6, 5, 8, 199);
    			add_location(li2, file$6, 8, 8, 325);
    			add_location(li3, file$6, 10, 12, 379);
    			add_location(ul1, file$6, 9, 8, 361);
    			add_location(li4, file$6, 12, 8, 454);
    			add_location(br, file$6, 14, 82, 582);
    			add_location(li5, file$6, 14, 12, 512);
    			add_location(ul2, file$6, 13, 8, 494);
    			add_location(li6, file$6, 17, 8, 659);
    			add_location(li7, file$6, 19, 12, 708);
    			add_location(ul3, file$6, 18, 8, 690);
    			add_location(ul4, file$6, 3, 4, 148);
    			add_location(h2, file$6, 24, 8, 820);
    			attr_dev(div0, "id", "footer");
    			add_location(div0, file$6, 23, 4, 793);
    ...
    /* src\Current.svelte generated by Svelte v3.44.2 */

    const { Object: Object_1$2 } = globals;
    const file$5 = "src\\Current.svelte";
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$5, 49, 16, 1169);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select, "change", /*setGame*/ ctx[8], false, false, false)
    				];
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$5, 51, 20, 1273);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:20) {#each items as item}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			add_location(p, file$5, 56, 20, 1444);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "size", "2");
    			add_location(input, file$5, 57, 20, 1477);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
    			insert_dev(target, input, anchor);
    			set_input_value(input, /*yaw*/ ctx[3]);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*input_input_handler*/ ctx[11]),
    					listen_dev(input, "input", /*convertSens*/ ctx[9], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*yaw*/ 8 && input.value !== /*yaw*/ ctx[3]) {
    				set_input_value(input, /*yaw*/ ctx[3]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$5(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = !/*custom*/ ctx[5].yaw && create_if_block_1$2(ctx);
    	let if_block1 = /*custom*/ ctx[5].yaw && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h1 = element("h1");
    			h1.textContent = "Calculate Current Sensitivity";
    			t1 = space();
    			div6 = element("div");
    			div2 = element("div");
    			...
    			button.textContent = "Use Custom Yaw";
    			t5 = space();
    			div3 = element("div");
    			p0 = element("p");
    			p0.textContent = "Current Sensitivity:";
    			t7 = space();
    			...
    			t13 = text(/*cm*/ ctx[4]);
    			t14 = text(" cm/360");
    			add_location(h1, file$5, 44, 12, 1028);
    			add_location(div0, file$5, 43, 8, 1009);
    			add_location(button, file$5, 60, 20, 1615);
    			add_location(div1, file$5, 59, 16, 1588);
    			add_location(div2, file$5, 47, 12, 1111);
    			add_location(p0, file$5, 64, 16, 1764);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "size", "1");
    			add_location(input0, file$5, 65, 16, 1809);
    			add_location(div3, file$5, 63, 12, 1741);
    			add_location(p1, file$5, 68, 16, 1937);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "size", "1");
    			add_location(input1, file$5, 69, 16, 1966);
    			add_location(div4, file$5, 67, 12, 1914);
    			add_location(h3, file$5, 72, 16, 2093);
    			add_location(div5, file$5, 71, 12, 2070);
    			add_location(div6, file$5, 46, 8, 1092);
    			add_location(main, file$5, 42, 4, 993);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*sens*/ ctx[1]);
    			append_dev(div6, t8);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*setGame*/ ctx[8], false, false, false),
    					listen_dev(input0, "input", /*input0_input_handler*/ ctx[12]),
    					listen_dev(input0, "input", /*convertSens*/ ctx[9], false, false, false),
    					listen_dev(input1, "input", /*input1_input_handler*/ ctx[13]),
    					listen_dev(input1, "input", /*convertSens*/ ctx[9], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*sens*/ 2 && input0.value !== /*sens*/ ctx[1]) {
    				set_input_value(input0, /*sens*/ ctx[1]);
    			}
    			...
    			if (dirty & /*cm*/ 16) set_data_dev(t13, /*cm*/ ctx[4]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function toggle() {
    		$$invalidate(5, custom.yaw = !custom.yaw, custom);
    	}

    	function setGame() {
    		for (const [key, values] of Object.entries(games_dic)) {
    			if (key == value) {
    				$$invalidate(3, yaw = values[0]);
    				precision = values[1];
    			}
    		}
    	}
    	...
    	function convertSens() {
    		$$invalidate(4, cm = Number.parseFloat(realCM(sens)).toFixed(2));
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('yaw' in $$props) $$invalidate(3, yaw = $$props.yaw);
    		if ('precision' in $$props) precision = $$props.precision;
    		if ('cm' in $$props) $$invalidate(4, cm = $$props.cm);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			h30 = element("h3");
    			h30.textContent = "Generate Random Sensitivity for:";
    			t3 = space();
    			if (if_block0) if_block0.c();
    			t4 = space();
    			if (if_block1) if_block1.c();
    			...
    			add_location(h30, file$4, 54, 12, 1218);
    			...
    			add_location(h31, file$4, 82, 12, 2211);
    			add_location(h32, file$4, 83, 12, 2261);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h30, file$3, 69, 4, 1956);
    			add_location(br, file$3, 70, 63, 2067);
    			add_location(h31, file$3, 70, 4, 2008);
    ...
    function create_if_block_1(ctx) {
    	let current;
    	let current$1;
    	current = new Current({ $$inline: true });
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*page*/ ctx[0] === "#current") return 1;
    		if (/*page*/ ctx[0] === "#random") return 2;
    		if (/*page*/ ctx[0] === "#convertCM") return 3;
    		if (/*page*/ ctx[0] === "#convertFL") return 4;
    		if (/*page*/ ctx[0] === "#convertFOV") return 5;
    		return 6;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			a1 = element("a");
    			a1.textContent = "Find out your cm/360";
    			t5 = space();
    			a2 = element("a");
    			a2.textContent = "Random Sensitvity";
    			t7 = space();
    			a3 = element("a");
    			a3.textContent = "Convert: Distance";
    			t9 = space();
    			a4 = element("a");
    			a4.textContent = "Convert: Focal Length";
    			t11 = space();
    			a5 = element("a");
    			a5.textContent = "Convert: FOV";
    			t13 = space();
    			div1 = element("div");
    			if_block.c();
    			add_location(h1, file, 16, 12, 458);
    			attr_dev(a0, "href", "#home");
    			add_location(a0, file, 17, 12, 485);
    			attr_dev(a1, "href", "#current");
    			add_location(a1, file, 18, 12, 523);
    			attr_dev(a2, "href", "#random");
    			add_location(a2, file, 19, 12, 580);
    			attr_dev(a3, "href", "#convertCM");
    			add_location(a3, file, 20, 12, 633);
    			attr_dev(a4, "href", "#convertFL");
    			add_location(a4, file, 21, 12, 689);
    			attr_dev(a5, "href", "#convertFOV");
    			add_location(a5, file, 22, 12, 749);
    			attr_dev(div0, "id", "sidebar");
    			attr_dev(div0, "class", "pane svelte-1cktkt6");
    			add_location(div0, file, 15, 8, 413);
    			attr_dev(div1, "id", "content");
    			attr_dev(div1, "class", "pane svelte-1cktkt6");
    			add_location(div1, file, 24, 8, 813);
    			attr_dev(div2, "id", "page");
    			attr_dev(div2, "class", "svelte-1cktkt6");
    			add_location(div2, file, 14, 4, 388);
    			attr_dev(main, "id", "main");
    			add_location(main, file, 13, 0, 366);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
