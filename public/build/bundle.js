    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$4, 51, 16, 1272);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = text(" cm/360)");
    			add_location(h1, file$4, 44, 8, 1032);
    			add_location(div0, file$4, 43, 4, 1017);
    			add_location(h3, file$4, 48, 12, 1121);
    			if (/*value*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[9].call(select));
    			add_location(select, file$4, 49, 12, 1176);
    			add_location(div1, file$4, 47, 8, 1102);
    			add_location(p0, file$4, 56, 12, 1401);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "size", "1");
    			add_location(input0, file$4, 57, 12, 1426);
    			add_location(p1, file$4, 58, 12, 1487);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "size", "1");
    			add_location(input1, file$4, 59, 12, 1512);
    			add_location(p2, file$4, 60, 12, 1575);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "size", "1");
    			add_location(input2, file$4, 61, 12, 1600);
    			add_location(div2, file$4, 55, 8, 1382);
    			add_location(button, file$4, 64, 12, 1695);
    			add_location(div3, file$4, 63, 8, 1676);
    			add_location(p3, file$4, 67, 12, 1796);
    			add_location(p4, file$4, 68, 12, 1844);
    			add_location(div4, file$4, 66, 8, 1777);
    			add_location(div5, file$4, 46, 4, 1087);
    			add_location(main, file$4, 42, 0, 1005);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
