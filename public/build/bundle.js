    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			if_block.c();
    			add_location(h1, file, 15, 12, 417);
    			attr_dev(a0, "href", "#home");
    			add_location(a0, file, 16, 12, 444);
    			attr_dev(a1, "href", "#random");
    			add_location(a1, file, 17, 12, 482);
    			attr_dev(a2, "href", "#convertCM");
    			add_location(a2, file, 18, 12, 535);
    			attr_dev(a3, "href", "#convertFL");
    			add_location(a3, file, 19, 12, 591);
    			attr_dev(a4, "href", "#convertFOV");
    			add_location(a4, file, 20, 12, 651);
    			attr_dev(div0, "id", "sidebar");
    			attr_dev(div0, "class", "pane svelte-1cktkt6");
    			add_location(div0, file, 14, 8, 372);
    			attr_dev(div1, "id", "content");
    			attr_dev(div1, "class", "pane svelte-1cktkt6");
    			add_location(div1, file, 22, 8, 715);
